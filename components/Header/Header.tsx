...
export default function Header() {
    return (
        <>
            <div className="flex items-center  justify-around  py-3  header ">
                ...
                <div className="flex items-center">
                    <div className="md:hidden">
                        <Sheet  >
                            ...
                            <SheetContent side={'left'} className="w-[350px] sm:w-[540px] md:hidden" >
                                <SheetHeader>
                                    <SheetTitle className='flex items-center' ><Image priority src={logo} alt='logo' width={30} />
                    ...
                    <Button variant="outline" className='auth-button'>Sign In</Button>
                </div>
            </div>
        </>
